...
void			ft_free(void *p, size_t unused);
...
void			ft_lsttailadd(t_list **tail, t_list *addee);
...
void			ft_memswap(void *a, void *b, size_t sz);
...
void			ft_scleanfree(void **data, size_t sz);
